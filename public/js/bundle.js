...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFudGFuMjAwMCIsImEiOiJjbGM3dzBkNTYwNHI1M3Vxcnd0aDcwejhxIn0.MIN71jWYvq84KFTK65OFFw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/tantan2000/clc85zsst000815nrmd1oy4jr',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Email was send successfully');
            window.setTimeout(function () {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MMUMnIykDyvAtFGwAsPNuoW0MbS0Id0s2ZmitRHVqckdN78ZqFoqAAC09IIyknhAGY5iefAH2ZICq93Cp1IdBkk00aJPxKqGO');
...
var forgotPasswordBtn = document.querySelector('.forgot-password');
var resetPasswordBtn = document.querySelector('.reset-password');
...
if (resetPasswordBtn) {
  resetPasswordBtn.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, _forgotPassword.resetPassword)(password, passwordConfirm);
  });
}
